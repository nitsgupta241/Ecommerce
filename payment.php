...
?>
<h2 align="center" style="padding:2px;">Pay now with Paypal: Click the image to proceed!</h2>

<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" >

<!-- Identify your business so that you can collect the payments. -->
<input type="hidden" name="business" value="nitish287@gmail.com">
...
<input type="image" name="submit" border="0" width="800" height="120"
